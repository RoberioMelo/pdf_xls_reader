...
class Application:
    def __init__(self, master=None):
        ...
        self.quartoContainer.pack(anchor="c", padx=0, pady=10)

        self.setemoContainer = customtkinter.CTkFrame(master=None, fg_color="transparent")
        self.setemoContainer.pack(anchor="c", padx=0, pady=10)
        ...
        self.executar.pack()
        # Salvar
        self.salvarR = customtkinter.CTkButton(self.setemoContainer, text="Salvar",
                                               command=self.salvar)
